  ...
  <div class="row">
    <div class="col-sm-4">
      <ul class="nav nav-pills flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="DeleteEmployee.jsp"><b>Delete Employee</b></a>
        </li>
      </ul>
    ...
    <div class="col-sm-4">
                    <label for="EmployeeId" class=" control-label">Enter EmployeeId :</label></div>
                    <div class="col-sm-4">
                        <input type="text" name="employeeId" id="Employee Id" placeholder="Employee Id" required class="form-control" autofocus>
                    </div>
