<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="com.ts.dao.TransactionsDAO,com.ts.dto.Transactions,java.util.List,java.util.ArrayList,com.ts.dao.CustomerDAO,com.ts.dto.Customer,com.ts.dao.AccountsDAO,com.ts.dto.Accounts,com.ts.dto.Employee,com.ts.dao.EmployeeDAO"%>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<title>Samridhi View All Transactions Page</title>
...
Employee employee = employeeDao.getEmployee(empId);TransactionsDAO transactionsDAO = new TransactionsDAO();
...
Welcome <%=employee.getfName() + " " + employee.getlName()%></font></div>
  <div class="row">
    <div class="col-sm-4">
      <ul class="nav nav-pills flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="ViewAllTransactions.jsp"><b>View all Transactions</b></b></a>
        </li>
    ...
    <table  class="table table-striped">
		<tr>
			...
			if (transaction.getBeneficiaryAccNo() != 0) { %>
			<tr>
				<td><%=transaction.getTransactionDate() %></td>
				<td><%=transaction.getAccountNumber()%></td>
				<td><%= "Transferred to " + transaction.getBeneficiaryAccNo()%>
		...
		<tr>
				<td><%=transaction.getTransactionDate() %></td>
				<td><%=transaction.getAccountNumber()%></td>
				<%if (transaction.getMode().equalsIgnoreCase("deposit")) { %>
				<td><%= "Self Deposit"%></td>
				<td></td>
				<td><%=transaction.getAmount() %>
				<%} else { %>
