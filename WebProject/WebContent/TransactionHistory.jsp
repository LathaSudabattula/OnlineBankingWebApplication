<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="java.util.List, java.util.ArrayList, com.ts.dao.CustomerDAO, com.ts.dto.Customer, com.ts.dao.TransactionsDAO, com.ts.dto.Transactions"%>
  ...
  <div class="row">
    <div class="col-sm-4">
      ...
      <ul class="nav nav-pills flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link bg-info active" href="TransactionHistory.jsp"><i class="fa fa-fw fa-history fa-lg" aria-hidden="true"></i><b>Transaction History</b></a>
        </li>
        <li class="nav-item">
    ...
    <div class="col-sm-8">
    <p align="right">Hello..${customer.firstName} ${customer.lastName}</p>
    </br>
