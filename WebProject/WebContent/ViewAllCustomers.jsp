<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="com.ts.dao.CustomerDAO,com.ts.dto.Customer,java.util.List,java.util.ArrayList, com.ts.dto.Accounts,com.ts.dto.Employee,com.ts.dao.EmployeeDAO"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
<title>Samridhi View all Customers Page</title>
...
List<Customer> validaccounts = new ArrayList<Customer>();
for (Customer customer: customers) {
	if(customer.getAccount().getStatus().equalsIgnoreCase("enabled")) {
		validaccounts.add(customer);
	}
}
  ...
  <div class="row">
    <div class="col-sm-3">
      <ul class="nav nav-pills flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="ViewAllCustomers.jsp"><b>View all Customers</b></a>
        </li>
        <li class="nav-item">
     ...
     <div style="overflow-x:auto;">
      <table border=2 align=center class="table table-striped">
		...
		<%for (Customer customer: validaccounts) { %>
			<tr>
				...
				<td><%=customer.getAddressNumber()%></td>
				<td><%=customer.getAadharNumber() %></td>
				<td><%=customer.getCustomerEmail()%></td>
				<td><%=customer.getAccount().getAccountNumber()%></td>
				<td><%=customer.getAccount().getBalance()%></td>
				<td><%=customer.getAccount().getAccountOpenDate()%></td>
				</tr>
		<%} %>
	</table>
      </div>
