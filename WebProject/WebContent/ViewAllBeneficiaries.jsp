...
<!DOCTYPE html>
<title>Samridhi Manage Beneficiaries Page</title>
...
Welcome <%=customer.getFirstName() + " " + customer.getLastName()%></font>
  ...
  <div class="row">
    ...
    <div class="col-sm-8">
    <div class="navbar1">
   <a class="active" href="ViewAllBeneficiaries.jsp">View All Beneficiaries</a> 
...
<%for (Beneficiary benef : beneficiary) {
	 ...
	 Accounts baccount = accountsDao.getAccount(benef.getBeneficiaryAccNumber());%>
<tr>
<td><%=benef.getBeneficiaryAccNumber()%></td>
<td><%=baccount.getCustomer().getFirstName() + " " + baccount.getCustomer().getLastName() %></td>
<td><%=benef.getTransactionLimit()%></td>
<td><%=benef.getStatus()%></td>
</tr>
<%} %>
